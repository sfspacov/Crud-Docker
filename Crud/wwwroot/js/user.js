            ...
            columns: [
                ...
                { title: "Cidade" },
                {
                    ...
                    render: function (data, type, row) {
                        return '<img onclick="edit(\'' + data[1] + '\')" style="cursor:pointer" src="../img/edit-icon.png" width="35" /> ' +
                            '<img style="cursor:pointer" onclick="deleteUser(\'' + data[1] + '\')" src="../img/delete-icon.png" width="35" />';
                    }
                },
            ],
            language: {
